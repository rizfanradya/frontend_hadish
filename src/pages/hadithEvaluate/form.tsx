...
export default function FormHadithEvaluate({
  data,
  getData,
  setGetData,
  typeHadithData,
  ...
  async function onSubmit() {
    try {
      setLoading(true);
      await axiosInstance.put(`/hadith_assesment/${data?.id}`, {
          ...
          >
            ...
            >
              <Typography
                ...
                onPointerLeaveCapture={undefined}
              >
                {data?.hadith_info.hadith_melayu}
              </Typography>
            </CardBody>
          </Card>
